...
def text(img, positon, text, color=(0, 0, 255), font_size=30, modify=False):
    if modify:
        img_ = img
    else:
        img_ = img.copy()
    ...
    font = ImageFont.truetype("/home/xian/Documents/code/PPDM_la/Datasets/STSONG.TTF", font_size)
    draw.text(positon, str(text), fill=color, font=font)
