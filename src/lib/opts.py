...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dcn_L1', action='store_true')
        # system
        ...
        self.parser.add_argument('--save_epoch', type=int, default=90,
                                 help='total training epochs.')
        ...
        self.parser.add_argument('--match_weight', type=float, default=0.1,
        ...
        self.parser.add_argument('--hard_negative_radius', type=int, default=3)
        self.parser.add_argument('--soft_gaussian', action='store_true')

        self.parser.add_argument('--hm_rel_dcn25_i_match', action='store_true')
        self.parser.add_argument('--hm_rel_dcn25_i_casc_match', action='store_true')

        self.parser.add_argument('--test_refine', action='store_true')
        self.parser.add_argument('--test_mul', action='store_true')
        self.parser.add_argument('--test_add', action='store_true')

        self.parser.add_argument('--model_begin', type=int)
        self.parser.add_argument('--model_end', type=int)

        self.parser.add_argument('--recover_loss_weight', action='store_true')
        self.parser.add_argument('--refine_weight', type=float, default=0.1)
        self.parser.add_argument('--casc_weight', type=float, default=1)
        self.parser.add_argument('--test_top_K_rel', type=int, default=100)
        #####################################################################################
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        if opt.task == 'hoidet':
            ...
            if opt.hm_rel_dcn25_i_casc_match or opt.hm_rel_dcn25_i_match:
                opt.heads.update({'sub_offset': 2 * opt.num_classes_verb})
                opt.heads.update({'obj_offset': 2 * opt.num_classes_verb})
        else:
